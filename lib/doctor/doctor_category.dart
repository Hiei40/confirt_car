...
class AllDoctorsCategory extends StatelessWidget {
  const AllDoctorsCategory({super.key, required this.Clinic,required this.Category});
  final String Clinic;
                              ...
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => ProfileDoctor(
                                    IDDoctor: cubit.DocotorsCategoryId[i],
                                    clinic: Clinic,
                                    DoctorInfo: cubit.allDoctorCategoryList[i],
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                "${cubit.allDoctorCategoryList[i]["name"]}",
                                                style: TextStyle(
                                                    color: Colors
                                                        .blueAccent.shade700,
                                                    fontSize: 20,
                                              ...
                                              Text(
                                                "${cubit.allDoctorCategoryList[i]["type"]}",
                                                style: TextStyle(
                                              ...
                                              Text(
                                                "${cubit.allDoctorCategoryList[i]["number"].toString()}:الكشف ",
                                                style: TextStyle(
                                                  color: Colors.grey.shade500,
                                                  fontSize: 12,
                                                ),
